...
/**
 * Import library Date to handle data attribute
 */
...
public class Song implements Comparable<Song> {
	 ...
	 * Class attributes 
	 * 
	 * title: stores the title of the song // identifier attribute:
	 * stores the record identifier number // date attribute: stores the song's
	 * release date // duration attribute: stores the time in seconds that the song
	 * lasts // gender attribute: stores the genre type of the song //  cover
	 * attribute: stores the cover of the song // description attribute: stores a
	 * brief description of the song // year attribute: stores the year the song
	 * was released.
	 */	
