...
/**
 * Import libraries ArrayList for handling arrays and JOptionPane to generate a window where the user sees the menu and can choose his option
 */
...
public class LibrarySongs<songs> {
	...
	/**
	 * Class attributes
	 * songs: stores the number of songs
	 * filter: store search criteria
	 */
